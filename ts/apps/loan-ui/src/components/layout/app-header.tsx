/**
 * App header — Loan Origination branding with New Application and conversation history.
 */
...
export function AppHeader() {
  ...
  return (
    ...
    >
      ...
      {/* Right side — Upload Doc + History + New Application */}
      <div className="flex items-center gap-2">
        ...
        {/* New Application button — only visible with messages */}
        {messages.length > 0 && (
          <button
