 ...
 *
 * User messages: right-aligned, dark background (elegant SAG contrast).
 * Bot messages: left-aligned, avatar + clean markdown body.
 * Uses react-markdown + remark-gfm for full markdown support:
 * headings, lists, code blocks, tables, links, inline formatting.
 */
...
/* ── Custom markdown components for a polished ChatGPT-like look ── */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Inline trace panel (bot messages only) */}
        {!isUser && message.traceDetails && (
          <TracePanel traceDetails={message.traceDetails} />
        )}
      </div>
